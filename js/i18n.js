const TRANSLATIONS = {
  ms: {
    ...
    scan_open: 'Buka Kamera Scan',
    scan_stop: 'Tutup Kamera',
    scan_open: 'Buka Kamera Scan',
    scan_stop: 'Tutup Kamera',
    guard_scan_desc: 'Imbas QR atau taip kod',
    guard_walkin_desc: 'Daftar pelawat tanpa QR',
    guard_checkout_desc: 'Rekod pelawat keluar',
    guard_log_desc: 'Semua rekod hari ini',
    guard_checkout_sub: 'Pelawat yang masih berada di dalam',
    guard_no_inside: 'Tiada pelawat dalam bangunan.',
    // Guard & Scan Fixes
    guard_scan: 'Semak & Check In',
    guard_checkout: 'Check Out',
    guard_walkin: 'Daftar Walk-in',
    guard_tab_all: 'Semua Rekod',
    guard_scan_ph: 'Masukkan Kod Rujukan (KESXXXXXX)',
    guard_log_desc: 'Semua rekod pendaftaran pelawat',
    guard_approve_checkin: 'Lulus & Check In',
    vis_ref_code: 'KOD RUJUKAN',
    vis_check_btn: 'Semak Pelawat',
    vis_vehicle_type: 'Jenis Kenderaan',
    vis_vehicle_plate: 'No. Plat Kenderaan',
    
    // Labels tambahan yang berkaitan
    reg_by_visitor: 'Daftar: Pelawat (Sendiri)',
    reg_by_owner: 'Daftar: Pemilik',
    reg_by_tenant: 'Daftar: Penyewa',
    reg_by_guard: 'Daftar: Security',
    ...
    vis_status_checkout: 'Telah Keluar',
     ...
     // Scan & Feedbacks
    scan_success: 'QR Berjaya Diimbas!',
    scan_failed: 'Gagal mengimbas QR. Sila cuba lagi.',
    ...
    vis_ref_code: 'KOD RUJUKAN',
    loading: 'Memuatkan...',
    status_checkedin: 'Telah Masuk',
      vis_vehicle_type_ph: '— Pilih jenis kenderaan —',
    vis_vehicle_plate_ph: 'Contoh: WXX 1234',
    vis_purpose_ph: '— Pilih tujuan melawat —',
      guard_contacts: 'HUBUNGI UNIT',
    guard_checkin_ok: 'Check In berjaya!',
    guard_checkout_ok: 'Check Out berjaya!',
    guard_updated: 'Status dikemas kini.',
    
    // Related Scan Feedback
    ...
    // Action Buttons
    guard_checkin: 'Check In Sekarang',
    guard_checkout: 'Check Out Sekarang',
    guard_approve_checkin: 'Lulus & Check In',
    admin_prev: '← Sebelum',
admin_next: 'Seterusnya →',
  ...
  en: {
    ...
    scan_open: 'Open QR Scanner',
    scan_stop: 'Stop Scanner',
    scan_open: 'Open QR Scanner',
    scan_stop: 'Stop Scanner',
    guard_scan_desc: 'Scan QR or type code',
    guard_walkin_desc: 'Register visitor without QR',
    guard_checkout_desc: 'Record visitor exit',
    guard_log_desc: 'All records for today',
    guard_checkout_sub: 'Visitors currently inside',
    guard_no_inside: 'No visitors inside the building.',
    guard_scan: 'Check & Check In',
    guard_checkout: 'Check Out',
    guard_walkin: 'Register Walk-in',
    guard_tab_all: 'All Records',
    guard_scan_ph: 'Enter Reference Code (KESXXXXXX)',
    guard_log_desc: 'All visitor registration records',
    guard_approve_checkin: 'Approve & Check In',
    vis_ref_code: 'REFERENCE CODE',
    vis_check_btn: 'Check Visitor',
    ...
    scan_failed: 'QR Scan Failed. Please try again.',
    vis_check_not_found: 'Reference code not found.',
    
    // Vehicle Related
    vis_vehicle_type: 'Vehicle Type',
    vis_vehicle_plate: 'Plate Number',
    vis_vehicle_car: 'Car',
    ...
    vis_vehicle_plate_ph: 'e.g. WXX 1234',
    vis_purpose_ph: '— Select visit purpose —',
    guard_contacts: 'CONTACT UNIT',
    ...
    guard_expired: 'QR Expired (>24 hours)',
    guard_not_approved: 'Not approved by owner',
    
    guard_checkin: 'Check In Now',
    guard_checkout: 'Check Out Now',
    guard_approve_checkin: 'Approve & Check In',
    admin_prev: '← Previous',
admin_next: 'Next →',
  ...
  zh: {
    ...
    scan_open: '开启扫码器',
    scan_stop: '关闭扫码器',
    guard_scan_desc: '扫描 QR 或输入代码',
    guard_walkin_desc: '现场登记',
    guard_checkout_desc: '访客离场登记',
    guard_log_desc: '今日所有记录',
    guard_checkout_sub: '仍在建筑物内的访客',
    guard_no_inside: '建筑物内没有访客。',
    guard_scan: '扫描与登记',
    guard_checkout: '登记离开',
    guard_walkin: '现场登记',
    guard_tab_all: '所有记录',
    guard_scan_ph: '输入参考代码 (KESXXXXXX)',
    guard_log_desc: '系统所有访客登记记录',
    guard_approve_checkin: '批准并登记进入',
    vis_ref_code: '参考代码',
    vis_check_btn: '检查访客',
    vis_vehicle_type: '车辆类型',
    vis_vehicle_plate: '车牌号',
    ...
    vis_ref_code: '参考代码',
    loading: '加载中...',
    status_checkedin: '已进入',
    vis_vehicle_type_ph: '— 选择车辆类型 —',
    vis_vehicle_plate_ph: '例如: WXX 1234',
    vis_purpose_ph: '— 选择访问目的 —',
    guard_contacts: '联系单位',
    guard_checkin_ok: '登记进入成功！',
    guard_checkout_ok: '登记离开成功！',
    guard_updated: '状态已更新。',
    
    guard_already_in: '访客已登记进入',
    guard_already_out: '访客已登记离开',
    guard_expired: 'QR 码已过期',
    guard_not_approved: '业主尚未批准',
    
    guard_checkin: '立即登记进入',
    guard_checkout: '立即登记离开',
    guard_approve_checkin: '批准并登记进入',
    admin_prev: '← 上一页',
admin_next: '下一页 →',
  ...
  ta: {
    ...
    scan_open: 'QR ஸ்கேனரைத் திறக்கவும்',
    scan_stop: 'ஸ்கேனரை நிறுத்து',
    scan_open: 'ஸ்கேனரைத் திறக்கவும்',
    scan_stop: 'ஸ்கேனரை நிறுத்து',
    guard_scan_desc: 'QR ஸ்கேன் அல்லது டைப் செய்யவும்',
    guard_walkin_desc: 'நேரடிப் பதிவு',
    guard_checkout_desc: 'வெளியேறுவதை பதிவு செய்யவும்',
    guard_log_desc: 'இன்றைய அனைத்து பதிவுகளும்',
    guard_checkout_sub: 'இன்னும் உள்ளே இருக்கும் பார்வையாளர்கள்',
    guard_no_inside: 'உள்ளே பார்வையாளர்கள் யாரும் இல்லை.',
    guard_scan: 'ஸ்கேன் செய்து உள்நுழைக',
    guard_checkout: 'வெளியேறுதல்',
    guard_walkin: 'நேரடிப் பதிவு',
    guard_tab_all: 'அனைத்து பதிவுகள்',
    guard_scan_ph: 'குறிப்பு எண்ணை உள்ளிடவும் (KESXXXXXX)',
    guard_log_desc: 'அனைத்து பார்வையாளர் பதிவு விவரங்கள்',
    guard_approve_checkin: 'அங்கீகரித்து உள்நுழையவும்',
    vis_ref_code: 'குறிப்பு எண்',
    vis_check_btn: 'சரிபார்க்கவும்',
    vis_vehicle_type: 'வாகன வகை',
    vis_vehicle_plate: 'வாகன எண்',
    ...
    vis_status_checkout: 'வெளியேறியுள்ளார்',
    // Scan & Feedbacks
    scan_success: 'QR வெற்றிகரமாக ஸ்கேன் செய்யப்பட்டது!',
    scan_failed: 'ஸ்கேன் தோல்வியடைந்தது. மீண்டும் முயற்சிக்கவும்.',
    vis_check_not_found: 'குறிப்பு எண் காணப்படவில்லை.',
    
    // Vehicle Related
    vis_vehicle_type: 'வாகன வகை',
    vis_vehicle_plate: 'வாகன எண்',
    vis_vehicle_car: 'கார்',
    vis_vehicle_moto: 'மோட்டார் சைக்கிள்',
    vis_vehicle_lorry: 'லாரி / வேன்',
    vis_vehicle_none: 'வாகனம் இல்லை',
    
    // UI Labels
    scan_open: 'கேமராவைத் திறக்கவும்',
    scan_stop: 'கேமராவை நிறுத்து',
    vis_check_btn: 'சரிபார்க்கவும்',
    vis_ref_code: 'குறிப்பு எண்',
    loading: 'ஏற்றுகிறது...',
    status_checkedin: 'உள்ளே வந்துள்ளார்',
     vis_vehicle_type_ph: '— வகையைத் தேர்ந்தெடுக்கவும் —',
    vis_vehicle_plate_ph: 'உதாரணம்: WXX 1234',
    vis_purpose_ph: '— வருகை நோக்கத்தைத் தேர்ந்தெடுக்கவும் —',
     guard_contacts: 'வீட்டைத் தொடர்பு கொள்ளவும்',
    guard_checkin_ok: 'உள்நுழைவு வெற்றிகரமாக முடிந்தது!',
    guard_checkout_ok: 'வெளியேற்றம் வெற்றிகரமாக முடிந்தது!',
    guard_updated: 'நிலை புதுப்பிக்கப்பட்டது.',
    
    guard_already_in: 'ஏற்கனவே உள்ளே வந்துள்ளார்',
    guard_already_out: 'ஏற்கனவே வெளியேறியுள்ளார்',
    guard_expired: 'QR காலம் முடிந்தது',
    guard_not_approved: 'உரிமையாளர் அங்கீகரிக்கவில்லை',
    
    guard_checkin: 'இப்போது உள்நுழைக',
    guard_checkout: 'இப்போது வெளியேறவும்',
    guard_approve_checkin: 'அங்கீகரித்து உள்நுழையவும்',
    admin_prev: '← முந்தைய',
admin_next: 'அடுத்தது →',
  }
